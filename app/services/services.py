...
def solve_vrp():
    """Solves the VRP problem and minimizes the longest single route."""
    ...
    distance_dimension.SetGlobalSpanCostCoefficient(100)  # Minimize the longest route
...
def print_solution(data, manager, routing, solution):
    ...
    print('Maximum of the longest route distance: {}m'.format(max_route_distance))
